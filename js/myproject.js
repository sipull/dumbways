...
function renderBlog() {
  ...
  for (let index = 0; index < BlogStorage.length; index++) {
    ...
    <div class="blog-content">
      <h1><a href="/html/blog.html" target="_blank">${
        BlogStorage[index].namespro
      } - ${getFullTime(BlogStorage[index].postAt)}</a>
      </h1>
      <div class="blog-detail">
      <p style="color: grey">${getDistanceTime(BlogStorage[index].postAt)}</p>
      </div>
      <p>
